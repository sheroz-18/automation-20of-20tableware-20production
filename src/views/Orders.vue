<template>
  <div class="space-y-8">
    ...
    <div class="flex gap-4 flex-wrap">
      <div class="flex-1 min-w-64 bg-white rounded-lg border border-slate-200 p-4">
        ...
        <input
          ...
          class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-black placeholder-gray-500"
        />
      </div>
      <div class="bg-white rounded-lg border border-slate-200 p-4">
        ...
        <select
          ...
          class="px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-black cursor-pointer"
        >
      ...
      <div class="bg-white rounded-lg border border-slate-200 p-4">
        ...
        <select
          ...
          class="px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-black"
        >
      ...
      <div class="bg-white rounded-lg border border-slate-200 p-4">
        <label class="text-sm font-medium text-slate-700 block mb-2">Экспорт</label>
        <div class="flex gap-2">
          <button
            @click="exportToExcel"
            class="px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm font-medium transition flex items-center gap-2"
          >
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path
                d="M3 2a1 1 0 011-1h12a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V2z M7 5a1 1 0 100 2h6a1 1 0 100-2H7z M7 9a1 1 0 100 2h6a1 1 0 100-2H7z M7 13a1 1 0 100 2h6a1 1 0 100-2H7z"
              />
            </svg>
            Excel
          </button>
          <button
            @click="exportToPdf"
            class="px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm font-medium transition flex items-center gap-2"
          >
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path
    ...
    <ConfirmClearModal
      ...
      message="Это удалит все заказы из системы. Все связанные партии производства и финансовые записи, созданные на основе этих заказов, останутся, но сами заказы будут удалены."
