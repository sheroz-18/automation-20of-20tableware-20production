  ...
  <div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        ...
        <p class="text-4xl font-bold">{{ formatCurrencyAmount(totalIncome) }}</p>
      ...
      <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-6 text-white shadow-sm">
        ...
        <p class="text-4xl font-bold">{{ formatCurrencyAmount(totalExpense) }}</p>
      ...
      >
        ...
        <p class="text-4xl font-bold">{{ formatCurrencyAmount(netBalance) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between p-3 rounded-lg bg-slate-100">
              ...
              <span class="font-semibold text-slate-900">{{ formatCurrencyAmount(0) }}</span>
            </div>
          </div>
        </div>
      </div>
